...
import { FormGroup, FormBuilder, AbstractControl, ValidationErrors, ValidatorFn } from '@angular/forms';
  ...
  constructor(private router: Router, fb: FormBuilder, private authService: AuthService) {
      ...
      this.form = fb.group({
        ...
        confirmPassword: ['', [Validators.required('enter matching password'),
          passwordMatchValidator(this.form.get('password').value, 'Passwords do not match')]],
        librarianUser: [false, Validators.requiredTrue]
      });
    }
